...
## name: Anzeigename | basis: Kosten des ersten Exemplars
## rate: Credits/s pro Stueck | farbe: Leitfarbe der Baugruppe
##
## Die Farben sind bewusst weit auseinander gelegt: auf einem Handydisplay
## muss man die Baugruppen im Vorbeiwischen auseinanderhalten koennen.
const TABELLE: Array[Dictionary] = [
    {"name": "Solarsegel",     "basis": 15.0,        "rate": 0.1,     "farbe": Color(0.98, 0.76, 0.24)},
    {"name": "Bergbaudrohne",  "basis": 100.0,       "rate": 1.0,     "farbe": Color(0.92, 0.47, 0.20)},
    {"name": "Schmelzofen",    "basis": 1100.0,      "rate": 8.0,     "farbe": Color(0.89, 0.29, 0.27)},
    {"name": "Hydroponik",     "basis": 12000.0,     "rate": 47.0,    "farbe": Color(0.35, 0.80, 0.44)},
    {"name": "Werkstatt",      "basis": 130000.0,    "rate": 260.0,   "farbe": Color(0.29, 0.76, 0.82)},
    {"name": "Fusionsreaktor", "basis": 1400000.0,   "rate": 1400.0,  "farbe": Color(0.62, 0.44, 0.94)},
    {"name": "Frachtdock",     "basis": 20000000.0,  "rate": 7800.0,  "farbe": Color(0.36, 0.56, 0.95)},
    {"name": "Forschungslabor","basis": 330000000.0, "rate": 44000.0, "farbe": Color(0.85, 0.88, 0.92)},
]
